            ...
            <div class="border p-3 rounded">
                ...
                <div class="mt-3 flex space-x-2">
                    @if(auth()->check() && auth()->user()->isAdmin())
                        ...
                        <button wire:click.prevent="delete({{ $category->id }})" class="inline-flex items-center justify-center w-8 h-8 rounded bg-red-500 text-white" title="Hapus" aria-label="Hapus">
